// Testes do vector implementado com lista duplamente ligada

public class TesteVectorLDL {
    public static void main(String[] args) {
        // vetor vazio
        VectorLDL v = new VectorLDL();
        ...
        // testa crescimento da lista (sem limite de capacidade)
        VectorLDL pequeno = new VectorLDL();
        pequeno.insertAtRank(0, 1);
        pequeno.insertAtRank(1, 2);
        pequeno.insertAtRank(2, 3);
